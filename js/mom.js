...
momObj.prototype.draw = function()
{
    ...
    let momTailPic = momTail[this.momTailCount];
    let momEyePic = momEye[this.momEyeCount];
    ...
    ctx1.drawImage(momEyePic, -momEyePic.width * 0.5, -momEyePic.height * 0.5);

    ctx1.drawImage(momTailPic, -momTailPic.width * 0.5 +30, -momTailPic.height * 0.5);
